    ...
    <>
      ...
      <div className="grid grid-cols-4 gap-3 mb-5">
        <div
          ...
          className={`bg-[#1a1a1a] rounded-lg p-4 cursor-pointer transition-all text-center ${filter === 'ALL' ? 'ring-2 ring-cyan-500' : 'hover:bg-gray-900'}`}
        >
        ...
        <div
          ...
          className={`bg-[#1a1a1a] rounded-lg p-4 cursor-pointer transition-all text-center ${filter === 'RAISE' ? 'ring-2 ring-cyan-500' : 'hover:bg-gray-900'}`}
        >
        ...
        <div
          ...
          className={`bg-[#1a1a1a] rounded-lg p-4 cursor-pointer transition-all text-center ${filter === 'LOWER' ? 'ring-2 ring-cyan-500' : 'hover:bg-gray-900'}`}
        >
        ...
        <div
          ...
          className={`bg-[#1a1a1a] rounded-lg p-4 cursor-pointer transition-all text-center ${filter === 'HOLD' ? 'ring-2 ring-cyan-500' : 'hover:bg-gray-900'}`}
        >
          ...
          <table className="w-full text-sm">
            <thead className="bg-black">
              <tr className="text-gray-400 text-xs uppercase">
                ...
                <th className="text-center p-2.5">Urgency</th>
                ...
                return (
                  <tr key={i} className={`border-t border-gray-800 hover:bg-gray-700 ${bgClass}`}>
                    ...
                    <td className="p-2.5 text-right text-gray-400">
                      {rec.impressions > 0 ? ((rec.clicks / rec.impressions) * 100).toFixed(0) + '%' : '\u2014'}
                    </td>
                    ...
                    <td className="p-2.5 text-center text-gray-300 text-xs">{rec.urgency}</td>
                    <td className="p-2.5 text-center">
