    ...
    <>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div
          ...
          className={`bg-[#1a1a1a] rounded-lg p-6 cursor-pointer transition-all text-center ${filter === 'ALL' ? 'ring-2 ring-green-500' : 'hover:bg-gray-900'}`}
        >
        ...
        <div
          ...
          className={`bg-[#1a1a1a] rounded-lg p-6 cursor-pointer transition-all text-center ${filter === 'RAISE' ? 'ring-2 ring-green-500' : 'hover:bg-gray-900'}`}
        >
        ...
        <div
          ...
          className={`bg-[#1a1a1a] rounded-lg p-6 cursor-pointer transition-all text-center ${filter === 'LOWER' ? 'ring-2 ring-green-500' : 'hover:bg-gray-900'}`}
        >
        ...
        <div
          ...
          className={`bg-[#1a1a1a] rounded-lg p-6 cursor-pointer transition-all text-center ${filter === 'HOLD' ? 'ring-2 ring-green-500' : 'hover:bg-gray-900'}`}
        >
