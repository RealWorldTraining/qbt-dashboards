...
// Bing columns: AY=50 Impressions, AZ=51 Clicks, BB=53 AverageCPC, BC=54 Spend, BD=55 Conversions
const COL_CLICKS = 51
const COL_IMPRESSIONS = 50
const COL_AVG_CPC = 53
const COL_SPEND = 54
const COL_CONVERSIONS = 55
...
export async function GET() {
  try {
    ...
    console.error('Bing trends error:', error)
    return NextResponse.json({ error: 'Failed to fetch Bing trends' }, { status: 500 })
  }
}
