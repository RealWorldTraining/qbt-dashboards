...
// Columns A (date) and BO:BR (Organic, Direct, Referral, Paid conversions)
const RANGE = 'Summary: Day!A:BR'
...
// BO=66, BP=67, BQ=68, BR=69
const COL_ORGANIC = 66
const COL_DIRECT = 67
const COL_REFERRAL = 68
const COL_PAID = 69
...
export async function GET() {
  try {
    ...
    console.error('Conversion trends error:', error)
    return NextResponse.json({ error: 'Failed to fetch conversion trends' }, { status: 500 })
  }
}
