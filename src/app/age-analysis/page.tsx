    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 text-lg">Monthly trends by age group from 2024 to present</p>
        </div>

        {/* Clicks Chart */}
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
          <h2 className="text-3xl font-bold mb-6 text-blue-400">Clicks by Age Group</h2>
        ...
        {/* Impressions Chart */}
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
          <h2 className="text-3xl font-bold mb-6 text-green-400">Impressions by Age Group</h2>
          <ResponsiveContainer width="100%" height={400}>
        ...
        {/* CTR Chart */}
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
          <h2 className="text-3xl font-bold mb-6 text-amber-400">Click-Through Rate (CTR) by Age Group</h2>
          <ResponsiveContainer width="100%" height={400}>
        ...
        {/* Average CPC Chart */}
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
          <h2 className="text-3xl font-bold mb-6 text-red-400">Average CPC by Age Group</h2>
          <ResponsiveContainer width="100%" height={400}>
        ...
        {/* Cost/Spend Chart */}
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
          <h2 className="text-3xl font-bold mb-6 text-purple-400">Cost (Spend) by Age Group</h2>
          <ResponsiveContainer width="100%" height={400}>
        ...
        {/* Conversions Chart */}
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
          <h2 className="text-3xl font-bold mb-6 text-pink-400">Conversions by Age Group</h2>
          <ResponsiveContainer width="100%" height={400}>
        ...
        <div className="text-center text-gray-500 text-sm mt-12 pb-8">
          <p>Data source: Google Ads (Adveronix Sheet)</p>
